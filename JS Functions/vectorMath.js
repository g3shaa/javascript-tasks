/*Когато се използва "use strict", 
JavaScript интерпретаторът изпълнява кода 
във възможно най-строг режим, 
който забранява използването на определени функции 
и позволява по-прецизна проверка на синтаксиса. */
'use strict'
